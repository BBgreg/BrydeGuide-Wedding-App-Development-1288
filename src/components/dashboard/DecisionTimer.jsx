  ...
  return (
    <motion.div
      ...
      className={`rounded-lg p-4 border-2 mb-6 ${
        ...
        urgencyLevel === 'moderate' ? 'bg-accent-50 border-accent-200' : ''
      } ${
        urgencyLevel === 'normal' ? 'bg-primary-50 border-primary-200' : ''
      } ${
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className={`p-2 rounded-full ${
            ...
            urgencyLevel === 'moderate' ? 'bg-accent-100' : ''
          } ${
            urgencyLevel === 'normal' ? 'bg-primary-100' : ''
          } ${
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <motion.div
              className={`h-2 rounded-full transition-all duration-1000 ${
                ...
                urgencyLevel === 'moderate' ? 'bg-accent-500' : ''
              } ${
                urgencyLevel === 'normal' ? 'bg-primary-500' : ''
              }`}
              style={{ 
